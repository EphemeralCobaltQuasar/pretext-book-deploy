...
},
{
  ...
  "number": "1.1",
  "title": "Math",
  "body": " Math  sources, primer on spectral sequences, wikipedia, stacks project.   scheme   a scheme is a locally ringed space such that every point has an open neighbourhood which is an affine scheme.     locally ringed space   a such that every stalk of the structure sheaf is a local ring.     ringed space   a pair consisting of a topological space X and a sheaf of rings on it.     topological space   a topological space X is a pair consisting of a set X and a set of subsets satisfying the axioms of topology.     set   a collection of stuff.     class   a collection of objects. more or less a set. but differentiated to avoid weird behavior.     ordinal   a is transitive if x T implies x T. A set x is an ordinal if it is transitive and well-ordered by . define . this is another ordinal called the successor of x. x is called a successor ordinal if there exist a y such that x=y+1. the small ordinal is or 0. if x is not 0 and not a successor ordinal, x is a limit ordinal. the first limit ordinal is . first uncountable ordinal is , the set of all countable ordinals. the collection of all ordinals is a proper class. it is well ordered by , meaning, any nonempty set of ordinals has a least element. given a set of ordinals A, its supremum is defined to be, . it is the least ordinal bigger or equal to all given any well ordered set (S, ), there is a unique ordinal a such that (S, ) is isomorphic to (a, ), this is called the order type of the well ordered set.     homologically graded spectral sequence   A homologically graded spectral sequence consists of a sequence of -bigraded R  together with differentials such that . A morphism of spectral sequences is a family of morphisms of complexes such that is the morphism induced by . from A PRIMER ON SPECTRAL SEQUENCES     module   A left R-module M consists of an (M, +) and an operation such that for all r, s in R and x, y in M, we have    from wikipedia.     abelian group   A  .     commutative   A is said to be commutative over a set S if all elements in that set when using that .     commute   x commutes with y if .     group   A set G with a , + or . with the following, , , and      graded   A graded is a R where the underlying additive is a of      ring   A group R with two , addition + and multiplication . R is an under addition and a under multiplication. Multiplication is distributive with respect to addition,      monoid   A monoid is a set S with a binary operation which is and has an .     direct sum   Direct sum is a with and   . Direct sum of a number of objects is isomorphic to the corresponding direct product. This is not the case for or an number of objects in the direct sum.     finite   If a number x is , there exist a N such that N x.     natural number   An starting from 1 and onwards. (sometimes starting from 0).     integer   Whole number. Can be negative, positive or zero.     infinite   A number x is said to be infinite if for any N, x N.     nonabelian group   A that is not an .     up to   Two objects can be said to be equal up to some .     equivalence relation   An equivalence relation is a that is , , and .     binary relation   A binary relation is a set of relating two sets. A is a binary relation with a restriction on the first element of the pair having to be unique.     ordered pairs   A pair of objects (a, b). Order matters, that is, (a, b) is different from (b, a).     reflexive   A is reflexive on A if for all a in A, (a, a).     symmetric   A ~ is symmetric over A if for every a, b in A,      transitive   A is transitive in a set A if for every a, b, c in A, if (a, b) and (b, c) then (a, c).     isomorphism   An isomorphism is a with an .     morphism   A that has and .     map   A map is a function that takes elements of set A to elements of set B, .     direct product        binary operation   Takes two elements and gives one. If the sets taken and given out is not specified, but the binary operation is specified over only one set S, assume the binary operation is an which takes two elements of that set to that set. .     infix operator   A binary operator which is placed between two elements.     associativity   A set S is associative if for all x, y, z in S,      identity element   A set S with a  has an identity element if there exist an element e such that, for all a in S, . The identity element is sometimes 0 (when the is +), or 1 (when the is )     inverse   A set S with a  has inverses if for every non-zero element, a in S, there exist an inverse in S so . Where e is the      identity map   a map that takes each element of a set to itself. acting as an but for maps.    "
},
{
  "id": "scheme",
  "level": "2",
  "url": "math.html#scheme",
  "type": "Definition",
  "number": "1.1.1",
  "title": "scheme.",
  "body": " scheme   a scheme is a locally ringed space such that every point has an open neighbourhood which is an affine scheme.   "
},
{
  "id": "locallyRingedSpace",
  "level": "2",
  "url": "math.html#locallyRingedSpace",
  "type": "Definition",
  "number": "1.1.2",
  "title": "locally ringed space.",
  "body": " locally ringed space   a such that every stalk of the structure sheaf is a local ring.   "
},
{
  "id": "ringedSpace",
  "level": "2",
  "url": "math.html#ringedSpace",
  "type": "Definition",
  "number": "1.1.3",
  "title": "ringed space.",
  "body": " ringed space   a pair consisting of a topological space X and a sheaf of rings on it.   "
},
{
  "id": "topologicalSpace",
  "level": "2",
  "url": "math.html#topologicalSpace",
  "type": "Definition",
  "number": "1.1.4",
  "title": "topological space.",
  "body": " topological space   a topological space X is a pair consisting of a set X and a set of subsets satisfying the axioms of topology.   "
},
{
  "id": "set",
  "level": "2",
  ...
  "number": "1.1.5",
  "title": "set.",
  "body": " set   a collection of stuff.   "
},
{
  "id": "class",
  "level": "2",
  ...
  "number": "1.1.6",
  "title": "class.",
  "body": " class   a collection of objects. more or less a set. but differentiated to avoid weird behavior.   "
},
{
  "id": "ordinal",
  "level": "2",
  "url": "math.html#ordinal",
  "type": "Definition",
  "number": "1.1.7",
  "title": "ordinal.",
  "body": " ordinal   a is transitive if x T implies x T. A set x is an ordinal if it is transitive and well-ordered by . define . this is another ordinal called the successor of x. x is called a successor ordinal if there exist a y such that x=y+1. the small ordinal is or 0. if x is not 0 and not a successor ordinal, x is a limit ordinal. the first limit ordinal is . first uncountable ordinal is , the set of all countable ordinals. the collection of all ordinals is a proper class. it is well ordered by , meaning, any nonempty set of ordinals has a least element. given a set of ordinals A, its supremum is defined to be, . it is the least ordinal bigger or equal to all given any well ordered set (S, ), there is a unique ordinal a such that (S, ) is isomorphic to (a, ), this is called the order type of the well ordered set.   "
},
{
  "id": "homologicallyGradedSpectralSequence",
  "level": "2",
  "url": "math.html#homologicallyGradedSpectralSequence",
  "type": "Definition",
  "number": "1.1.8",
  "title": "homologically graded spectral sequence.",
  "body": " homologically graded spectral sequence   A homologically graded spectral sequence consists of a sequence of -bigraded R  together with differentials such that . A morphism of spectral sequences is a family of morphisms of complexes such that is the morphism induced by . from A PRIMER ON SPECTRAL SEQUENCES   "
},
{
  "id": "module",
  "level": "2",
  "url": "math.html#module",
  "type": "Definition",
  "number": "1.1.9",
  "title": "module.",
  "body": " module   A left R-module M consists of an (M, +) and an operation such that for all r, s in R and x, y in M, we have    from wikipedia.   "
},
{
  "id": "abelianGroup",
  "level": "2",
  "url": "math.html#abelianGroup",
  "type": "Definition",
  "number": "1.1.10",
  "title": "abelian group.",
  "body": " abelian group   A  .   "
},
{
  "id": "commutative",
  "level": "2",
  "url": "math.html#commutative",
  "type": "Definition",
  "number": "1.1.11",
  "title": "commutative.",
  "body": " commutative   A is said to be commutative over a set S if all elements in that set when using that .   "
},
{
  "id": "commute",
  "level": "2",
  "url": "math.html#commute",
  "type": "Definition",
  "number": "1.1.12",
  "title": "commute.",
  "body": " commute   x commutes with y if .   "
},
{
  "id": "group",
  "level": "2",
  ...
  "number": "1.1.13",
  "title": "group.",
  "body": " group   A set G with a , + or . with the following, , , and    "
},
{
  "id": "graded",
  "level": "2",
  "url": "math.html#graded",
  "type": "Definition",
  "number": "1.1.14",
  "title": "graded.",
  "body": " graded   A graded is a R where the underlying additive is a of    "
},
{
  "id": "ring",
  "level": "2",
  ...
  "number": "1.1.15",
  "title": "ring.",
  "body": " ring   A group R with two , addition + and multiplication . R is an under addition and a under multiplication. Multiplication is distributive with respect to addition,    "
},
{
  "id": "monoid",
  "level": "2",
  "url": "math.html#monoid",
  "type": "Definition",
  "number": "1.1.16",
  "title": "monoid.",
  "body": " monoid   A monoid is a set S with a binary operation which is and has an .   "
},
{
  "id": "directSum",
  "level": "2",
  "url": "math.html#directSum",
  "type": "Definition",
  "number": "1.1.17",
  "title": "direct sum.",
  "body": " direct sum   Direct sum is a with and   . Direct sum of a number of objects is isomorphic to the corresponding direct product. This is not the case for or an number of objects in the direct sum.   "
},
{
  "id": "finite",
  "level": "2",
  "url": "math.html#finite",
  "type": "Definition",
  "number": "1.1.18",
  "title": "finite.",
  "body": " finite   If a number x is , there exist a N such that N x.   "
},
{
  "id": "naturalNumber",
  "level": "2",
  "url": "math.html#naturalNumber",
  "type": "Definition",
  "number": "1.1.19",
  "title": "natural number.",
  "body": " natural number   An starting from 1 and onwards. (sometimes starting from 0).   "
},
{
  "id": "integer",
  "level": "2",
  "url": "math.html#integer",
  "type": "Definition",
  "number": "1.1.20",
  "title": "integer.",
  "body": " integer   Whole number. Can be negative, positive or zero.   "
},
{
  "id": "infinite",
  "level": "2",
  "url": "math.html#infinite",
  "type": "Definition",
  "number": "1.1.21",
  "title": "infinite.",
  "body": " infinite   A number x is said to be infinite if for any N, x N.   "
},
{
  "id": "nonabelianGroup",
  "level": "2",
  "url": "math.html#nonabelianGroup",
  "type": "Definition",
  "number": "1.1.22",
  "title": "nonabelian group.",
  "body": " nonabelian group   A that is not an .   "
},
{
  "id": "upTo",
  "level": "2",
  ...
  "number": "1.1.23",
  "title": "up to.",
  "body": " up to   Two objects can be said to be equal up to some .   "
},
{
  "id": "equivalenceRelation",
  "level": "2",
  "url": "math.html#equivalenceRelation",
  "type": "Definition",
  "number": "1.1.24",
  "title": "equivalence relation.",
  "body": " equivalence relation   An equivalence relation is a that is , , and .   "
},
{
  "id": "binaryRelation",
  "level": "2",
  "url": "math.html#binaryRelation",
  "type": "Definition",
  "number": "1.1.25",
  "title": "binary relation.",
  "body": " binary relation   A binary relation is a set of relating two sets. A is a binary relation with a restriction on the first element of the pair having to be unique.   "
},
{
  "id": "orderedPairs",
  "level": "2",
  "url": "math.html#orderedPairs",
  "type": "Definition",
  "number": "1.1.26",
  "title": "ordered pairs.",
  "body": " ordered pairs   A pair of objects (a, b). Order matters, that is, (a, b) is different from (b, a).   "
},
{
  "id": "reflexive",
  "level": "2",
  "url": "math.html#reflexive",
  "type": "Definition",
  "number": "1.1.27",
  "title": "reflexive.",
  "body": " reflexive   A is reflexive on A if for all a in A, (a, a).   "
},
{
  "id": "symmetric",
  "level": "2",
  "url": "math.html#symmetric",
  "type": "Definition",
  "number": "1.1.28",
  "title": "symmetric.",
  "body": " symmetric   A ~ is symmetric over A if for every a, b in A,    "
},
{
  "id": "transitive",
  "level": "2",
  "url": "math.html#transitive",
  "type": "Definition",
  "number": "1.1.29",
  "title": "transitive.",
  "body": " transitive   A is transitive in a set A if for every a, b, c in A, if (a, b) and (b, c) then (a, c).   "
},
{
  "id": "isomorphism",
  "level": "2",
  "url": "math.html#isomorphism",
  "type": "Definition",
  "number": "1.1.30",
  "title": "isomorphism.",
  "body": " isomorphism   An isomorphism is a with an .   "
},
{
  "id": "morphism",
  "level": "2",
  "url": "math.html#morphism",
  "type": "Definition",
  "number": "1.1.31",
  "title": "morphism.",
  "body": " morphism   A that has and .   "
},
{
  "id": "map",
  "level": "2",
  ...
  "number": "1.1.32",
  "title": "map.",
  "body": " map   A map is a function that takes elements of set A to elements of set B, .   "
},
{
  "id": "directProduct",
  "level": "2",
  "url": "math.html#directProduct",
  "type": "Definition",
  "number": "1.1.33",
...
},
{
  "id": "binaryOperation",
  "level": "2",
  "url": "math.html#binaryOperation",
  "type": "Definition",
  "number": "1.1.34",
  "title": "binary operation.",
  "body": " binary operation   Takes two elements and gives one. If the sets taken and given out is not specified, but the binary operation is specified over only one set S, assume the binary operation is an which takes two elements of that set to that set. .   "
},
{
  "id": "infixOperator",
  "level": "2",
  "url": "math.html#infixOperator",
  "type": "Definition",
  "number": "1.1.35",
  "title": "infix operator.",
  "body": " infix operator   A binary operator which is placed between two elements.   "
},
{
  "id": "associativity",
  "level": "2",
  "url": "math.html#associativity",
  "type": "Definition",
  "number": "1.1.36",
  "title": "associativity.",
  "body": " associativity   A set S is associative if for all x, y, z in S,    "
},
{
  "id": "identityElement",
  "level": "2",
  "url": "math.html#identityElement",
  "type": "Definition",
  "number": "1.1.37",
  "title": "identity element.",
  "body": " identity element   A set S with a  has an identity element if there exist an element e such that, for all a in S, . The identity element is sometimes 0 (when the is +), or 1 (when the is )   "
},
{
  "id": "inverse",
  "level": "2",
  "url": "math.html#inverse",
  "type": "Definition",
  "number": "1.1.38",
  "title": "inverse.",
  "body": " inverse   A set S with a  has inverses if for every non-zero element, a in S, there exist an inverse in S so . Where e is the    "
},
{
  "id": "identityMap",
  "level": "2",
  "url": "math.html#identityMap",
  "type": "Definition",
  "number": "1.1.39",
  "title": "identity map.",
  "body": " identity map   a map that takes each element of a set to itself. acting as an but for maps.   "
},
{
  "id": "algebraicTopology",
  "level": "1",
  "url": "algebraicTopology.html",
  "type": "Section",
  "number": "1.2",
...
},
{
  ...
  "level": "2",
  "url": "algebraicTopology.html#algebraicTopology-3",
  "type": "Convention",
  "number": "1.2.1",
  "title": "",
  "body": " all maps are continuous unless stated otherwise.  "
},
{
  "id": "format",
  "level": "2",
  "url": "algebraicTopology.html#format",
  "type": "Definition",
  "number": "1.2.2",
  "title": "format.",
  "body": " format   my understanding esthesia  copy pasted. if its kinda informally written its my understanding. otherwise it is copy pasted.   "
},
{
  "id": "continuous",
  "level": "2",
  "url": "algebraicTopology.html#continuous",
  "type": "Definition",
  "number": "1.2.3",
  "title": "continuous.",
  "body": " continuous   no abrupt changes. esthesia   "
},
{
  "id": "deformationRetraction",
  "level": "2",
  "url": "algebraicTopology.html#deformationRetraction",
  "type": "Definition",
  "number": "1.2.4",
  "title": "deformation retraction.",
  "body": " deformation retraction   given a space X and a subspace A, a deformation retraction is a function over an interval that starts at X and ends in A thats continuous. esthesia  A deformation retraction of a space onto a subspace is a family of maps  , , such that ( ), , and for all . The family should be in the sense that the associated  , , is .   "
},
{
  "id": "attachingSpaces",
  "level": "2",
  "url": "algebraicTopology.html#attachingSpaces",
  "type": "Definition",
  "number": "1.2.5",
  "title": "attaching spaces.",
  "body": " attaching spaces   we stick X1 to X0 following what f says. X0 with X1 attached along f, . f takes A to X0. A subset of X1. esthesia  We start with a space and another space that we wish to attach to by identifying the points in a subspace with points of . xre The data needed to do this is a  , for then we can form a space of by identifying each point with its image . We denote this space by , the space with  attached along A via f . When we have the case of attaching an -cell to via a  .   "
},
{
  "id": "mappingCone",
  "level": "2",
  "url": "algebraicTopology.html#mappingCone",
  "type": "Definition",
  "number": "1.2.6",
  "title": "mapping cone.",
  "body": " mapping cone   Closely related to the  is the mapping cone  , where is the cone . We attach this to along via the identifications .   "
},
{
  "id": "mappingCylinder",
  "level": "2",
  "url": "algebraicTopology.html#mappingCylinder",
  "type": "Definition",
  "number": "1.2.7",
  "title": "mapping cylinder.",
  "body": " mapping cylinder   The mapping cylinder of a map is the space obtained from by attaching along via .   "
},
{
  "id": "homotopy",
  "level": "2",
  "url": "algebraicTopology.html#homotopy",
  "type": "Definition",
  "number": "1.2.8",
  "title": "homotopy.",
  "body": " homotopy   a homotopy takes a function to another over an interval. esthesia  Formally, a homotopy between two continuous functions and from a topological space to a topological space is defined to be a continuous function from the product of the space with the unit interval to such that and for all . wikipedia   "
},
{
  "id": "homotopic",
  "level": "2",
  "url": "algebraicTopology.html#homotopic",
  "type": "Definition",
  "number": "1.2.9",
  "title": "homotopic.",
...
},
{
  "id": "retraction",
  "level": "2",
  "url": "algebraicTopology.html#retraction",
  "type": "Definition",
  "number": "1.2.10",
  "title": "retraction.",
  "body": " retraction   a retraction of onto , a  such that and .   "
},
{
  "id": "homotopyRelativeTo",
  "level": "2",
  "url": "algebraicTopology.html#homotopyRelativeTo",
  "type": "Definition",
  "number": "1.2.11",
  "title": "homotopy relative to.",
  "body": " homotopy relative to   when homotopy is restricted to A, it doesnt change with time, or t. esthesia.  In general, a homotopy whose restriction to a subspace is independent of is called a homotopy relative to  , or more concisely, a homotopy rel  .   "
},
{
  "id": "homotopyEquivalence",
  "level": "2",
  "url": "algebraicTopology.html#homotopyEquivalence",
  "type": "Definition",
  "number": "1.2.12",
  "title": "homotopy equivalence.",
  "body": " homotopy equivalence   A  is called a homotopy equivalence if there is a  such that and .   "
},
{
  "id": "homotopyEquivalent",
  "level": "2",
  "url": "algebraicTopology.html#homotopyEquivalent",
  "type": "Definition",
  "number": "1.2.13",
  "title": "homotopy equivalent.",
  "body": " homotopy equivalent   The spaces and are said to be homotopy equivalent or to have the same homotopy type if there exist a between them. The notation is .   "
},
{
  "id": "homotopyType",
  "level": "2",
  "url": "algebraicTopology.html#homotopyType",
  "type": "Definition",
  "number": "1.2.14",
  "title": "homotopy type.",
  "body": " homotopy type   The spaces and are said to be homotopy equivalent or to have the same homotopy type if there exist a between them. The notation is .   "
},
{
  "id": "contractible",
  "level": "2",
  "url": "algebraicTopology.html#contractible",
  "type": "Definition",
  "number": "1.2.15",
  "title": "contractible.",
  "body": " contractible   A space having the of a point is called contractible . This amounts to requiring that the identity of the space be .   "
},
{
  "id": "nullhomotopic",
  "level": "2",
  "url": "algebraicTopology.html#nullhomotopic",
  "type": "Definition",
  "number": "1.2.16",
  "title": "nullhomotopic.",
  "body": " nullhomotopic    to a constant map   "
},
{
  "id": "cellComplex",
  "level": "2",
  "url": "algebraicTopology.html#cellComplex",
  "type": "Definition",
  "number": "1.2.17",
  "title": "cell complex.",
  "body": " cell complex     Start with a discrete set , whose points are regarded as 0-cells.  Inductively, form the -skeleton from by attaching -cells via maps  . This means that is the quotient space of the disjoint union of with a collection of -disks under the identifications for . Thus as a set, where each is an open -disk.  One can either stop this inductive process at a finite stage, setting for some , or one can continue indefinitely, setting . In the latter case is given the weak topology: a set is open (or closed) iff is open (or closed) in for each .  A space X constructed in this way is called a cell complex or CW complex .   "
},
{
  "id": "nCell",
  "level": "2",
  "url": "algebraicTopology.html#nCell",
  "type": "Definition",
  "number": "1.2.18",
  "title": "n-cell.",
  "body": " n-cell   An n-cell is a homeomorphic to a copy of the unit ball in . https:\/\/math.stackexchange.com\/a\/1486272   "
},
{
  "id": "nSkeleton",
  "level": "2",
  "url": "algebraicTopology.html#nSkeleton",
  "type": "Definition",
  "number": "1.2.19",
  "title": "n-skeleton.",
  "body": " n-skeleton   a n-skeleton is in a .   "
},
{
  "id": "dimension",
  "level": "2",
  "url": "algebraicTopology.html#dimension",
  "type": "Definition",
  "number": "1.2.20",
  "title": "dimension.",
  "body": " dimension   In a , if for some n, then X is said to be finite-dimensional, and the smallest such n is the dimension of X , the maximum dimension of cells of X .   "
},
{
  "id": "graph",
  "level": "2",
  "url": "algebraicTopology.html#graph",
  "type": "Definition",
  "number": "1.2.21",
  "title": "graph.",
  "body": " graph   a 1  , is a graph. consists of 0-cells (vertices or points), and 1 cells (edges connecting points). an edge can have both ends attached to the same vertex.   "
},
{
  "id": "eulerCharacteristic",
  "level": "2",
  "url": "algebraicTopology.html#eulerCharacteristic",
  "type": "Definition",
  "number": "1.2.22",
  "title": "euler characteristic.",
  "body": " euler characteristic   0-cells - 1-cells + 2-cells, gives the euler characteristic.   "
},
{
  "id": "realProjectiveNSpace",
  "level": "2",
  "url": "algebraicTopology.html#realProjectiveNSpace",
  "type": "Definition",
  "number": "1.2.23",
  "title": "real projective n space.",
  "body": " real projective n space    Real projective n-space  is defined to be the space of all lines through the origin in . Each such line is determined by a nonzero vector in , unique up to scalar multiplication, and is topologized as the space of under the equivalence relation for scalars .   "
},
{
  "id": "complexProjectiveNSpace",
  "level": "2",
  "url": "algebraicTopology.html#complexProjectiveNSpace",
  "type": "Definition",
  "number": "1.2.24",
  "title": "complex projective n space.",
  "body": " complex projective n space    Example 0.6. Complex projective n-space  is the space of complex lines through the origin in , that is, 1-dimensional vector subspaces of . As in the case of , each line is determined by a nonzero vector in , unique up to scalar multiplication, and is topologized as the space of under the equivalence relation for .   "
},
{
  "id": "characteristicMap",
  "level": "2",
  "url": "algebraicTopology.html#characteristicMap",
  "type": "Definition",
  "number": "1.2.25",
  "title": "characteristic map.",
  "body": " characteristic map   Each cell in a  has a characteristic map  which extends the attaching  and is a homeomorphism from the interior of onto .   "
},
{
  "id": "subcomplex",
  "level": "2",
  "url": "algebraicTopology.html#subcomplex",
  "type": "Definition",
  "number": "1.2.26",
  "title": "subcomplex.",
  "body": " subcomplex   A subcomplex of a  is a closed subspace that is a union of cells of .   "
},
{
  "id": "cwPair",
  "level": "2",
  "url": "algebraicTopology.html#cwPair",
  "type": "Definition",
  "number": "1.2.27",
  "title": "CW pair.",
  "body": " CW pair   A pair consisting of a  and a  will be called a CW pair .   "
},
{
  "id": "products",
  "level": "2",
  "url": "algebraicTopology.html#products",
  "type": "Definition",
  "number": "1.2.28",
  "title": "products.",
  "body": " products   If and are , then has the structure of a with the products where ranges over the of and ranges over the of .   "
},
{
  "id": "quotient",
  "level": "2",
  "url": "algebraicTopology.html#quotient",
  "type": "Definition",
  "number": "1.2.29",
  "title": "quotient.",
  "body": " quotient   for X\/A, compress A to a point. leave everything else in X the same. esthesia  If is a consisting of a  and a subcomplex , then the space inherits a natural structure from . The cells of are the cells of plus one new 0- , the image of in . For a  of attached by , the attaching for the corresponding in is the composition .   "
},
{
  "id": "suspension",
  "level": "2",
  "url": "algebraicTopology.html#suspension",
  "type": "Definition",
  "number": "1.2.30",
  "title": "suspension.",
...
},
{
  "id": "join",
  "level": "2",
  "url": "algebraicTopology.html#join",
  "type": "Definition",
  "number": "1.2.31",
  "title": "join.",
...
},
{
  "id": "simplex",
  "level": "2",
  "url": "algebraicTopology.html#simplex",
  "type": "Definition",
  "number": "1.2.32",
  "title": "simplex.",
  "body": " simplex   the of n points is a convex polyhedron of dimension n − 1 called a simplex.   "
},
{
  "id": "wedgeSum",
  "level": "2",
  "url": "algebraicTopology.html#wedgeSum",
  "type": "Definition",
  "number": "1.2.33",
  "title": "Wedge Sum.",
...
},
{
  "id": "smashProduct",
  "level": "2",
  "url": "algebraicTopology.html#smashProduct",
  "type": "Definition",
  "number": "1.2.34",
  "title": "smash product.",
...
},
{
  ...
  "level": "2",
  "url": "algebraicTopology.html#homotopyEquivalenceCwPair",
  "type": "Theorem",
  "number": "1.2.35",
  "title": "homotopy equivalence for a CW pair.",
  "body": " homotopy equivalence for a CW pair   If is a consisting of a  and a contractible subcomplex , then the   is a .   "
},
{
  "id": "reducedSuspension",
  "level": "2",
  "url": "algebraicTopology.html#reducedSuspension",
  "type": "Definition",
  "number": "1.2.36",
...
},
{
  ...
  "level": "2",
  "url": "algebraicTopology.html#homotopyExtensionProperty",
  "type": "Definition",
  "number": "1.2.37",
  "title": "homotopy extension property.",
  "body": " homotopy extension property   A pair has the homotopy extension property if and only if is a retract of .   "
},
{
  "id": "path",
  "level": "2",
  "url": "algebraicTopology.html#path",
  "type": "Definition",
  "number": "1.2.38",
  "title": "path.",
  "body": " path   By a path in a space we mean a continuous  where is the unit interval .   "
},
{
  "id": "homotopyOfPaths",
  "level": "2",
  "url": "algebraicTopology.html#homotopyOfPaths",
  "type": "Definition",
  "number": "1.2.39",
  "title": "homotopy of paths.",
  "body": " homotopy of paths   A homotopy of paths in is a family , , such that:    The endpoints and are independent of .  The associated  defined by is continuous.    When two paths and are connected in this way by a homotopy , they are said to be homotopic . The notation for this is .   "
},
{
  "id": "homotopyClass",
  "level": "2",
  "url": "algebraicTopology.html#homotopyClass",
  "type": "Definition",
  "number": "1.2.40",
  "title": "homotopy class.",
  "body": " homotopy class   The equivalence class of a path under the equivalence relation of will be denoted and called the homotopy class of .   "
},
{
  "id": "productPath",
  "level": "2",
  "url": "algebraicTopology.html#productPath",
  "type": "Definition",
  "number": "1.2.41",
  "title": "product path.",
  "body": " product path   Given two paths such that , there is a composition or product path  that traverses first and then , defined by the formula      "
},
{
  "id": "loop",
  "level": "2",
  "url": "algebraicTopology.html#loop",
  "type": "Definition",
  "number": "1.2.42",
  "title": "loop.",
...
},
{
  "id": "basepoint",
  "level": "2",
  "url": "algebraicTopology.html#basepoint",
  "type": "Definition",
  "number": "1.2.43",
  "title": "basepoint.",
  "body": " basepoint   A is a that the same start and end point, also referred to as a basepoint .   "
},
{
  "id": "setOfAllHomotopyClasses",
  "level": "2",
  "url": "algebraicTopology.html#setOfAllHomotopyClasses",
  "type": "Definition",
  "number": "1.2.44",
  "title": "set of all homotopy classes.",
  "body": " set of all homotopy classes   The set of all homotopy classes  of loops  at the  is denoted .   "
},
{
  "id": "fundamentalGroup",
  "level": "2",
  "url": "algebraicTopology.html#fundamentalGroup",
  "type": "Definition",
  "number": "1.2.45",
  "title": "fundamental group.",
  "body": " fundamental group    is a group with respect to the product , . This group is called the fundamental group of at the  .   "
},
{
  "id": "reparametrization",
  "level": "2",
  "url": "algebraicTopology.html#reparametrization",
  "type": "Definition",
  "number": "1.2.46",
  "title": "reparametrization.",
  "body": " reparametrization   A reparametrization of a path is a composition where is any continuous such that and .   "
},
{
  "id": "inversePath",
  "level": "2",
  "url": "algebraicTopology.html#inversePath",
  "type": "Definition",
  "number": "1.2.47",
  "title": "inverse path.",
  "body": " inverse path   For a path from to , the inverse path  from back to is defined by .   "
},
{
  "id": "changeOfBasepoint",
  "level": "2",
  "url": "algebraicTopology.html#changeOfBasepoint",
  "type": "Definition",
  "number": "1.2.48",
  "title": "change of basepoint.",
...
},
{
  ...
  "number": "1.4",
  "title": "Attributions",
  "body": " Attributions  wikipedia, math stack exchange, primer on spectral sequences, hatcher algebraic topology, chatgpt image to latex converter,  "
},
{
  "id": "backmatter-2",
  "level": "1",
  ...
  "number": "",
  "title": "Colophon",
  "body": " This book was xr in PreTeXt .  "
}
]
